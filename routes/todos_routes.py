...
@router.get('/todos/{id}',tags=["todos"], summary="get a todo")
def get_todo(id:str):
...
@router.put('/todos/{id}',tags=["todos"], summary="update a todo")
def update_todos(id:str, todo: TodoUpdate):
    return todos_cnt.update(id,todo)

@router.delete('/todos/{id}',tags=["todos"], summary="delete a todo")
